...
const collections = [
	...
	},
	{
		...
		stickers: [
			{
				path: "./Transportation/Artboard 6.png",
				value: "Transportation-CKS-1",
			},
			{
				path: "./Transportation/Artboard 8.jpg",
				value: "Transportation-CKS-2",
			},
	...
	},
	{
		...
		stickers: [
			{
				path: "./WasteManagement/Artboard 2.jpg",
				value: "Waste-management-CKS-1",
			},
			{
				path: "./WasteManagement/carbon 3.png",
				value: "Waste-management-CKS-2",
			},
			{ path: "./WasteManagement/Waste.jpeg", value: "Waste-management-CKS-3" },
		],
	},
	{
		collection: "Zero Carbon Lifestyle Practice",
		stickers: [
			{
				path: "./ZeroCarbonLifestylePractice/Artboard 3.jpg",
				value: "Zero-carbon-CKS-1",
			},
			{
				path: "./ZeroCarbonLifestylePractice/Artboard 7.png",
				value: "Zero-carbon-CKS-2",
			},
			{
				path: "./ZeroCarbonLifestylePractice/carbon 5.png",
				value: "Zero-carbon-CKS-3",
			},
			{
				path: "./ZeroCarbonLifestylePractice/Practices.jpeg",
				value: "Zero-carbon-CKS-4",
			},
		],
	},
];
	...
	return (
		<section className={"py-4 container mx-auto px-4 md:px-20"}>
			...
			<div className={"py-16 space-y-3"}>
				<h2>You have collected {data?.length || 0} stickers</h2>
				<h2 className={"text-lg font-medium"}>Your Collections</h2>

				<div className="space-y-3">
					{collections.map((collection, index) => (
						<div key={index}>
							<h2 className="font-bold underline">{collection.collection}</h2>
							<div
								className={
									"mt-2 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 w-full"
								}
							>
								{collection.stickers.map((sticker, index) => (
									<LazyLoadImage
										...
										alt={sticker.value}
										effect="blur"
										className={`w-full h-auto aspect-square rounded-md shadow-sm border-[1px] ${
											data?.find((stc) => stc.sticker_code === sticker.value)
												? "grayscale-0"
												: "grayscale"
										}`}
										wrapperProps={{
